...
const frutasReduce = ["manzana", "banana", "manzana", "cereza", "banana", "manzana"];
...
const celsiusFilter = [0, 15, -5, 22, 37, 100, -10, 28];

// Solo los pares
const celsiusaF = celsius.map(c => (c / 9/5)+32);
console.log(`Fahrenheit:`,celsiusaF);

const celsius30 = celsiusFilter.filter(n => n >= 0 && n <= 30);
console.log(`Entre 0 y 30°C:`,celsius30); 

const Fahrenheit = celsiusaF.filter(n => n >= 0 && n <= 30);
const Encadenamiento = Fahrenheit;
console.log(`Entre 0 y 30°C en °F:`,Encadenamiento); 
